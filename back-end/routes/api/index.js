...
router.get("/getbankaccount/:orgId/:bankDetailsId", protectApi, getBankAccount);
router.patch("/updatebankaccount/:orgId/:bankDetailsId", protectApi, updateBankAccount);
...
router.post("/createledgeraccount/:orgId", protectApi, createAccount);
router.patch("/updateledgeraccount/:orgId/:ledgerId", protectApi, updateLedgerAccount);
