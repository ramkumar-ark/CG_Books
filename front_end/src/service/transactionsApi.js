...
export const transactionsApi = createApi({
    ...
    endpoints: (builder) => ({
        ...
        getUnpaidInvoices: builder.query({
            query: (params) => `/api/getunpaidinvoices/${params.orgId}`,
            providesTags: ['ClosingBalance']
        }),
...
export const { 
    ...
    useGetLedgerTransactionsQuery, useGetAutoGeneratedVchNoQuery, useGetUnpaidInvoicesQuery,
    useUpdateOffsetTransactionsMutation,
} = transactionsApi;
