...
const RecordReceipt = ({edit}) => {
    ...
    const receiptData = useGetVoucher(transactionid, 'Receipt');
    // Getting data for Select customer component and customer display component
    const {entitySelectList: customerList, entityDataObj:customersObj} = useGetEntities();
    const {data: closingBalanceData} = useGetLedgerBalances();
    ...
    const unpaidInvoices = useGetUnpaidVouchers('sales');
